...
**Depends on:** Item 57 (CSS cascade layers — DONE, see [PLAN-DONE.md](./PLAN-DONE.md)). The `theme.css` location and layer architecture exist; primitives reference design tokens through the new path.
